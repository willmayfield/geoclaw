...
for j=1:num_gauges
    ...
    datafilename = ['/home/will/clawpack_src/clawpack-v5.4.1/geoclaw/examples/tsunami/hueneme/ENS_DATA_' num2str(dim) '/data_g' num2str(gaugeno(j),'%02d') '_n' num2str(ens_num) '.mat'];
    load(datafilename)
...
%     etar = etats_out.Data;
    ...
    datafilename = ['/home/will/clawpack_src/clawpack-v5.4.1/geoclaw/examples/tsunami/hueneme/ENS_DATA_' num2str(dim) '/p_data_g' num2str(gaugeno(j),'%02d') '_n' num2str(ens_num) '.mat'];
