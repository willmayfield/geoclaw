...
%     save(datafilename,'t','u','v','eta')
   ...
   % save(datafilename,'time','ug','vg','etag')
    refdatafilename = ['/home/will/clawpack_src/clawpack-v5.4.1/geoclaw/examples/tsunami/huenemegauss/GF_DATA_' num2str(dim) '/ref_data_g' num2str(gaugeno(j),'%02d') '.mat'];
