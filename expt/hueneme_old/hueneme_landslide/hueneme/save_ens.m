...
%     eta = eta_g - eta;
    ...
    datafilename = ['/home/will/clawpack_src/clawpack-v5.4.1/geoclaw/examples/tsunami/hueneme/ENS_DATA_' num2str(dim) '/data_g' num2str(gaugeno(j),'%02d') '_n' num2str(ensnum) '.mat'];
