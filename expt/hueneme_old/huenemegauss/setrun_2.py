...
#------------------------------
    ...
    clawdata.lower[0] = -119.30      # west longitude
...
#    rundata.regiondata.regions.append([3, 3, 8000., 26000., -90,-80,-30,-15])
    ...
    rundata.gaugedata.gauges.append([1, -119.2, 34.13, 0., 1.8e3])
...
#    rundata.qinit_data.qinitfiles.append([1,1,'/home/will/clawpack_src/clawpack-v5.4.1/geoclaw/examples/tsunami/hueneme/hump.xyz'])
